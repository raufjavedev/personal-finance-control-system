...
/**
 * Interfaz que define las operaciones de acceso a datos para la gestión de transacciones.
 * Proporciona métodos para agregar, actualizar, eliminar y consultar transacciones en la base de datos.
 */
public interface TransactionDAO {
    ...
    /**
     * Elimina todas las transacciones asociadas a un usuario específico.
     *
     * @param userId El identificador único del usuario cuyas transacciones se desean eliminar.
     */
    void deleteTransactionByUserId(int userId);
