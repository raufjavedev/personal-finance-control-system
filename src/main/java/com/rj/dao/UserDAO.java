...
/**
 * Interfaz que define las operaciones de acceso a datos para la gestión de usuarios.
 * Proporciona métodos para realizar operaciones CRUD y autenticación en la base de datos.
 */
